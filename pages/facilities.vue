...
Laurence Vial
			...
			<p style="clear:both;"><br>CIRAD is a French agricultural research center working for international development. The total number of employees is 1800 including 800 researchers. CIRAD is present in more than 90 countries with twelve regional offices and has a global network of partners. CIRAD bases its operation on development needs, from field to laboratory and from a local to global scale. Its activities involve life sciences, social sciences and engineering sciences applied to agriculture, food, natural resource management and society. Researchers from two units from CIRAD will be involved in this project: AGIRs and CMAEE.
							...
							<img src="@/assets/uploads/fac_cirad.png" width=400 style="float:left; padding-right: 15px"> 

			<p>AGIRs unit (Animal and Integrated Risk Management) develops research on analyses and management of sanitary risks which make communities, societies or agro-ecosystems more fragile. The range of expertise goes from analytic to evaluative epidemiology, social sciences (socio-economic issues) and simulation, modeling.</p>

			<p>CMAEE unit (Control of Exotic and Emerging Animal Diseases) is specialized in studying host-vector-pathogen interactions. It has been developing virology researches on ASFV for 10 years and has recently acquired the competence in soft tick rearing and the expertise on tick ecology by creating a section dedicated to arthropod vectors. It is in charge of BL-3 laboratories and BL-2 insectaries that will allow to conduct the necessary experimental studies proposed in this project. 
				</p>
...
<hr style="margin-top:50px; margin-bottom:50px">
        ...
        <div class="content">
          <h3>University of Pretoria (UP)</h3>
			...
			<img src="@/assets/uploads/fac_UP.png" width=400 style="float:left; padding-right: 15px"> 

<p>	The University of Pretoria is nationally and internationally recognized for the excellence of its research outputs. UP ambitions and activities are influenced by more than 100 years of learning, scholarship, research and public engagement.</p>
<p>Over a 20 year period, UP has on average produced the highest percentage (14%) of total South African research output, and rates more than 300 National Research Foundation-rated researchers among its academic staff – more than 12% of South Africa’s NRF-rated researchers.</p>

<p>The University of Pretoria’s consistent performance in research production and postgraduate output is further reflected in the number of journal articles that are listed in the International Scientific Index (ISI) and the International Bibliography of the Social Sciences (IBSS).</p>
...
<p>	The Onderstepoort Veterinary Institute (OVI) resides under the Agriculture Research Council, a parastatal organization in South Africa. The Transboundary Animal Diseases (TAD) is the division of the OVI that will be directly involved in this project. The main research areas for both FMD and ASF are epidemiology, phylogenetics and development of improved vaccines. OVI is housed in a biolevel 3 facility and is the OIE and FAO reference lab for ASF and the FAO reference lab for FMD in Africa. The TAD performs extensive research and diagnosis on ASF, FMD and classical swine fever and produces vaccine against FMD.
	</p><br><br>
...
<p>Currently, the main activities of VISAVET-UCM are related with the development of new diagnostic technologies, new vaccines, the study of bacterial and virus infections, molecular epidemiology, preventive medicine, and decision-support models for the control of animal diseases.  VISAVET-UCM has facilities-BSL2 and BSL3 laboratories - for the performance of molecular biology work, clinical assays with animals, bacteriological and virological diagnosis including viral cultures, cell cultures and immunology techniques. VISAVET-UCM is OIE reference laboratory for ASF and African horse sickness as well as European Union Reference Laboratory for Bovine Tuberculosis.
	</p>

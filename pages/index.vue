  ...
  <div id="home-page" class="page-wrapper home-page">
    ...
    <main-section theme="one-column">
      ...
      <div class="content">
        ...
        <h1 style="clear:both; font-size:30px;">Unravelling the Effect of Contact Networks 
          &amp; Socio-Economic Factors in the Emergence of Infectious Diseases 
          at the Wild-Domestic Interface</h1>

          <p>African swine fever (ASF) virus is a viral hemorrhagic disease of domestic swine and wild boar.  Its introduction to naïve populations can result in outbreaks causing up to 100% mortality.  Among commercial swine this can result in massive economic losses via high mortality, culling and trade restrictions.  Among subsistence farmers, loss of domestic swine can lead to devastating financial hardships and food insecurity.  Currently, there is no treatment and no vaccine available.
</p><p>
